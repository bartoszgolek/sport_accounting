 ...
 */
class Version20160416191246 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE booking_transaction (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, credit NUMERIC(10, 2) DEFAULT NULL, debit NUMERIC(10, 2) DEFAULT NULL, voucher VARCHAR(255) NOT NULL, date DATE DEFAULT NULL, INDEX IDX_55ACDE1816A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE documents_journal (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, type INT NOT NULL, committed TINYINT(1) NOT NULL, commit_time DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE documents_journal_position (id INT AUTO_INCREMENT NOT NULL, journal_id INT DEFAULT NULL, book_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, debit NUMERIC(10, 2) DEFAULT NULL, credit NUMERIC(10, 2) DEFAULT NULL, voucher VARCHAR(255) NOT NULL, date DATE DEFAULT NULL, INDEX IDX_165E2C09478E8802 (journal_id), INDEX IDX_165E2C0916A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE documents_journal_position ADD CONSTRAINT FK_165E2C09478E8802 FOREIGN KEY (journal_id) REFERENCES documents_journal (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE documents_journal_position DROP FOREIGN KEY FK_165E2C09478E8802');
