...
class Version20160413231126 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE documents_journal (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, type INT NOT NULL, committed TINYINT(1) NOT NULL, commit_time DATETIME, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
